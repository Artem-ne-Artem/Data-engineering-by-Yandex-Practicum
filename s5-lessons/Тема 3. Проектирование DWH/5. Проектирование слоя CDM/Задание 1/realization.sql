create table de.cdm.dm_settlement_report (
	id serial not null		--идентификатор записи
	,restaurant_id varchar not null 	--идентификатор ресторана (строковый, из системы-источника)
	...
	,restaurant_reward_sum numeric(14, 2) not null			--сумма, которую необходимо перечислить
);