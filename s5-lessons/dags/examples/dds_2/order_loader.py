...
from examples.dds_2.restaurant_loader import RestaurantDdsRepository
from examples.dds_2.timestamp_loader import TimestampDdsRepository
from examples.dds_2.user_loader import UserDdsRepository
from examples.dds_2.order_repositories import (OrderDdsObj, OrderDdsRepository, OrderJsonObj,
                                OrderRawRepository)
