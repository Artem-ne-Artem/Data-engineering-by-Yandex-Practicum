...
from examples.dds.deployer.fct_products_sales_repositories import EventJsonObj, EventRawRepository, FctProductDdsObj, ProductPaymentJsonObj, BonusPaymentJsonObj, FctProductDdsRepository
