...
class CourierOriginRepository:
    ...
    def load_couriers(self, sort_field: str, sort_direction: str, offset: int = 0, limit: int = 1000000) -> None:
        ...
        api_str = "https://d5d04q7d963eapoepsqr.apigw.yandexcloud.net/couriers?sort_field=%s&sort_direction=%s&limit=%d&offset=%d" % (
...
class REST_CourierLoader:
    ...
    def __init__(self, collection_loader: CourierOriginRepository, pg_dest: PgConnect, pg_saver: CourierDestRepository,
                 logger: Logger) -> None:
